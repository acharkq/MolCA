...
# python ft_clf.py --devices $devices --filename "ft_fg_smiels_regression_${filename}" --stage2_path "all_checkpoints/pt_${filename}_correct_tunegnn/last.ckpt" --opt_model $llm --mode ft --tune_gnn --prompt '[START_I_SMILES]{}[END_I_SMILES]. ' --init_lr 1e-4 --scheduler None --llm_tune lora --max_epochs 10 --task_type regression --root data/PubChemDataset_v4/ --smiles_only;
