...
python stage2_vicuna.py --devices $devices --filename "ft_${filename}" --stage2_path "all_checkpoints/ft_llama13b/epoch=${epoch}.ckpt" --opt_model $llm --max_epochs 100 --mode eval --tune_gnn --prompt 'The molecule\t' --init_lr 1e-4 --scheduler None --batch_size 8 --accumulate_grad_batches 4;
done
exit
}
