...
python stage2.py --devices $devices --filename "pt_${filename}_chebi_lora_smiles_prompt" --stage1_path "all_checkpoints/stage1_default/epoch=49-step=120950.ckpt" --opt_model $llm --max_epochs 100 --mode ft --prompt '[START_I_SMILES]{}[END_I_SMILES]. ' --tune_gnn --llm_tune lora --inference_batch_size 8 --root "data/ChEBI-20_data" --peft_config "PeftConfig/CheBI.json" ;
# MolT5 uses max_len=512

python stage2.py --devices $devices --filename "pt_${filename}_chebi_lorasmall_smiles_prompt" --stage1_path "all_checkpoints/stage1_default/epoch=49-step=120950.ckpt" --opt_model $llm --max_epochs 100 --mode ft --prompt '[START_I_SMILES]{}[END_I_SMILES]. ' --tune_gnn --llm_tune lora --inference_batch_size 8 --root "data/ChEBI-20_data" --peft_config "PeftConfig/CheBISmall.json" ;
