...
class TrainCollater:
    def __init__(self, tokenizer, text_max_len, use_gal=True):
    ...
    def __call__(self, batch):
        _, iupac, smiles_prompt = zip(*batch)
        if self.use_gal:
        ...
        text_tokens = self.tokenizer(text=iupac,
                                     truncation=True,
                                     padding='longest',
                                     add_special_tokens=True,
                                     max_length=self.text_max_len,
...
class InferenceCollater:
    ...
    def __call__(self, batch):
        ...
        smiles_prompt_tokens = self.tokenizer(text=smiles_prompt,
                                              ...
                                              return_tensors='pt',
                                              return_attention_mask=True)
        return smiles_prompt_tokens, iupac



class SmilesIupacDM(LightningDataModule):
    def __init__(
        self,
        mode: str = 'pretrain',
        num_workers: int = 0,
    ...
    def train_dataloader(self):
        ...
        loader = DataLoader(
            ...
            collate_fn=TrainCollater(self.tokenizer, self.text_max_len, use_gal=self.use_gal),
        )
        return loader
    ...
    def val_dataloader(self):
        ...
        test_loader = DataLoader(
            ...
            drop_last=False,
            persistent_workers=True,
            collate_fn=InferenceCollater(self.tokenizer, self.text_max_len, use_gal=self.use_gal),
        )
